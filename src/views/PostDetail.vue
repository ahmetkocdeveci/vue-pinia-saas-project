...
const fetchPostData = async () => {
  ...
  try {
    ...
    const response = await fetch(
      `https://stripiest-semichemically-emilee.ngrok-free.dev/${endpoint}/${id}`,
      {
        headers: {
    ...
    const relatedRes = await fetch(
      `https://stripiest-semichemically-emilee.ngrok-free.dev/${endpoint}?id_ne=${id}&_limit=3`,
      {
        headers: {
          "ngrok-skip-browser-warning": "true",
        },
  ...
  <div class="post-detail-page">
    <div class="container">
      ...
      <div v-else-if="!post" class="not-found">
        ...
        <router-link :to="`/${locale}/blog`" class="btn-back">{{
          t("blog.backToBlog")
        }}</router-link>
      </div>
